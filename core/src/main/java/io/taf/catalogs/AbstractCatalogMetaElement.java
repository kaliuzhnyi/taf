...
public abstract class AbstractCatalogMetaElement<ITEM_VIEW extends Component & CatalogItemView<ENTITY, ID, LIST_VIEW, ITEM_VIEW>,
        LIST_VIEW extends Component & CatalogListView<ENTITY, ID, ITEM_VIEW, LIST_VIEW>,
