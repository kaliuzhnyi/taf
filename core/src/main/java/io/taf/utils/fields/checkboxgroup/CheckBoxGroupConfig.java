...
@FieldCreationConfig
public @interface CheckBoxGroupConfig {
    ...
    /**
     * Specifies the class that will be used as a DataProvider to populate the options for the {@link CheckboxGroup} component.
     ...
     * {@code
     *
     * @return The {@link DataProvider} class used to provide data for the {@link CheckboxGroup} component. This class must implement
     * {@link DataProvider}.
     * @CheckboxGroupConfig(dataProvider = MyCustomDataProvider.class)
     * private Set<Object> myCheckboxGroup;
     * }
     * <p>
