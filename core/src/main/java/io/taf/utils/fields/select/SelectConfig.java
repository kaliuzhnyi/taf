...
public @interface SelectConfig {
     ...
     * <p>
     * Example usage:
     * {@code @SelectConfig(defaultValueProvider = MyDefaultValueProvider.class)}
    ...
    /**
     * Specifies the class that will be used as a DataProvider to populate the options for the {@link Select} component.
     ...
     * {@code
     *
     * @return The {@link DataProvider} class used to provide data for the {@link Select} component. This class must implement
     * {@link DataProvider}.
     * @SelectConfig(dataProvider = MyCustomDataProvider.class)
     ...
     * Corresponding method in Vaadin: {@link HasPrefix#setPrefixComponent(Component)}
     *
