...
/**
 * Annotation to configure a {@link Checkbox} component in a Vaadin application.
...
public @interface CheckBoxConfig {
    ...
    /**
     * Specifies the default value of the {@link Checkbox}.
     * Corresponding method in Vaadin: {@link Checkbox#setValue(Object)}
     *
