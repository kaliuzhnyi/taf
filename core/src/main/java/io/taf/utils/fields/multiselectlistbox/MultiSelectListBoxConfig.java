...
@FieldCreationConfig
public @interface MultiSelectListBoxConfig {
    ...
    /**
     * Specifies the class that will be used as a DataProvider to populate the options for the {@link MultiSelectListBox} component.
     ...
     * {@code
     *
     * @return The {@link DataProvider} class used to provide data for the {@link MultiSelectListBox} component. This class must implement
     * {@link DataProvider}.
     * @MultiSelectListBoxConfig(dataProvider = MyCustomDataProvider.class)
     * private String myMultiSelectListBox;
     * }
     * <p>
