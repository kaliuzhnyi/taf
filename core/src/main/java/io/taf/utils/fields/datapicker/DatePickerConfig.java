...
/**
 * Annotation to configure a {@link DatePicker} component in a Vaadin application.
...
public @interface DatePickerConfig {
    ...
    /**
     * Specifies the default value of the {@link DatePicker}.
     * The string should be in ISO-8601 format (e.g., "yyyy-MM-dd").
     * Corresponding method in Vaadin: {@link DatePicker#setValue(LocalDate)}
     *
     * @return The default value for the {@link DatePicker}.
     */
     ...
     * This is applicable to components like {@link DatePicker}.
     ...
     * The string should be in ISO-8601 format (e.g., "yyyy-MM-dd").
     * Corresponding method in Vaadin: {@link DatePicker#setMin(LocalDate)}
     *
     ...
     * The string should be in ISO-8601 format (e.g., "yyyy-MM-dd").
     * Corresponding method in Vaadin: {@link DatePicker#setMax(LocalDate)}
     *
