...
/**
 * Annotation to configure a {@link com.vaadin.flow.component.datetimepicker.DateTimePicker} component in a Vaadin application.
...
public @interface DateTimePickerConfig {
    ...
    /**
     * Specifies the default value of the {@link com.vaadin.flow.component.datetimepicker.DateTimePicker}.
     * The string should be in ISO-8601 format (e.g., "yyyy-MM-dd'T'HH:mm").
     * Corresponding method in Vaadin: {@link com.vaadin.flow.component.datetimepicker.DateTimePicker#setValue(LocalDateTime)}
     *
     * @return The default value for the {@link com.vaadin.flow.component.datetimepicker.DateTimePicker}.
     */
     ...
     * Corresponding method in Vaadin: {@link com.vaadin.flow.component.datetimepicker.DateTimePicker#setDatePlaceholder(String)}
     *
    ...
    /**
     * Specifies the placeholder text for the field.
     * Corresponding method in Vaadin: {@link com.vaadin.flow.component.datetimepicker.DateTimePicker#setTimePlaceholder(String)}
     *
     * @return The placeholder text.
     */
     ...
     * This is applicable to components like {@link com.vaadin.flow.component.datetimepicker.DateTimePicker}.
     ...
     * The string should be in ISO-8601 format (e.g., "yyyy-MM-dd'T'HH:mm").
     * Corresponding method in Vaadin: {@link com.vaadin.flow.component.datetimepicker.DateTimePicker#setMin(LocalDateTime)}
     *
     ...
     * The string should be in ISO-8601 format (e.g., "yyyy-MM-dd'T'HH:mm").
     * Corresponding method in Vaadin: {@link com.vaadin.flow.component.datetimepicker.DateTimePicker#setMax(LocalDateTime)}
     *
