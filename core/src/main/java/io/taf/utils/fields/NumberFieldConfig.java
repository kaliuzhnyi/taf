...
/**
 * Annotation to configure a {@link com.vaadin.flow.component.textfield.NumberField} component in a Vaadin application.
...
public @interface NumberFieldConfig {
    ...
    /**
     * Specifies the default value of the {@link com.vaadin.flow.component.textfield.NumberField}.
     * Corresponding method in Vaadin: {@link com.vaadin.flow.component.textfield.NumberField#setValue(Double)}
     *
    ...
    /**
     * Determines whether the step buttons is visible for the field.
     * Corresponding method in Vaadin: {@link com.vaadin.flow.component.textfield.NumberField#setStepButtonsVisible(boolean)}
     *
     * @return True if the clear button should be visible, false otherwise.
     */
     ...
     * Corresponding method in Vaadin: {@link com.vaadin.flow.component.textfield.NumberField#setMin(double)}
     * @return The minimum value.
     */
    double min() default Double.MIN_VALUE;

    /**
     * Specifies the maximum value allowed for the number field.
     * Corresponding method in Vaadin: {@link com.vaadin.flow.component.textfield.NumberField#setMax(double)}
     * @return The maximum value.
     */
    double max() default Double.MAX_VALUE;

    /**
     * Specifies the step value for the number field, defining the smallest interval between valid values.
     * Corresponding method in Vaadin: {@link com.vaadin.flow.component.textfield.NumberField#setStep(double)}
