...
@FieldCreationConfig
public @interface RadioButtonGroupConfig {
    ...
    /**
     * Specifies the class that will be used as a DataProvider to populate the options for the {@link RadioButtonGroup} component.
     ...
     * {@code
     *
     * @return The {@link DataProvider} class used to provide data for the {@link RadioButtonGroup} component. This class must implement
     * {@link DataProvider}.
     * @RadioButtonConfig(dataProvider = MyCustomDataProvider.class)
