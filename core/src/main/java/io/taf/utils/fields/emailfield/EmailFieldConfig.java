package io.taf.utils.fields.emailfield;
...
/**
 * Annotation to configure a {@link com.vaadin.flow.component.textfield.EmailField} component in a Vaadin application.
 * Enables declarative configuration of a {@link com.vaadin.flow.component.textfield.EmailField}, specifying properties such as ID, initial checked state, visibility,
 * and other attributes related to its appearance and behavior.
 * Designed to streamline the setup of {@link com.vaadin.flow.component.textfield.EmailField} components, ensuring consistency and reducing boilerplate in UI code.
 */
@Target(ElementType.FIELD)
@Retention(RetentionPolicy.RUNTIME)
@FieldCreationConfig
public @interface EmailFieldConfig {
