...
/**
 * Annotation to configure a {@link com.vaadin.flow.component.datepicker.DatePicker} component in a Vaadin application.
...
public @interface DatePickerConfig {
    ...
    /**
     * Specifies the default value of the {@link com.vaadin.flow.component.datepicker.DatePicker}.
     * The string should be in ISO-8601 format (e.g., "yyyy-MM-dd").
     * Corresponding method in Vaadin: {@link com.vaadin.flow.component.datepicker.DatePicker#setValue(LocalDate)}
     *
     * @return The default value for the {@link com.vaadin.flow.component.datepicker.DatePicker}.
     */
     ...
     * This is applicable to components like {@link com.vaadin.flow.component.datepicker.DatePicker}.
    ...
    /**
     * Specifies the minimum date allowed to be selected in the date picker.
     * The string should be in ISO-8601 format (e.g., "yyyy-MM-dd").
     * Corresponding method in Vaadin: {@link com.vaadin.flow.component.datepicker.DatePicker#setMin(LocalDate)}
     *
     * @return The minimum date in ISO-8601 format as a string.
     */
    String min() default "";

    /**
     * Specifies the maximum date allowed to be selected in the date picker.
     * The string should be in ISO-8601 format (e.g., "yyyy-MM-dd").
     * Corresponding method in Vaadin: {@link com.vaadin.flow.component.datepicker.DatePicker#setMax(LocalDate)}
     *
     * @return The maximum date in ISO-8601 format as a string.
     */
    String max() default "";
