...
@FieldCreationConfig
public @interface MultiSelectComboBoxConfig {
    ...
    /**
     * Specifies the class that will be used as a DataProvider to populate the options for the {@link MultiSelectComboBox} component.
     ...
     * {@code
     *
     * @return The {@link DataProvider} class used to provide data for the {@link MultiSelectComboBox} component. This class must implement
     * {@link DataProvider}.
     * @MultiSelectComboBoxConfig(dataProvider = MyCustomDataProvider.class)
     * private String myMultiSelectComboBox;
     * }
     * <p>
