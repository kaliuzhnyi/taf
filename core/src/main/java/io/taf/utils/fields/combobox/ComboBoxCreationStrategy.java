...
public class ComboBoxCreationStrategy implements FieldCreationStrategy<ComboBox> {

    @Getter(onMethod_ = {@Nonnull, @Override})
    private final Class<ComboBoxConfig> markedAnnotation = ComboBoxConfig.class;

    @Nonnull
    @Override
    public ComboBox createField(@Nonnull Field field, @Nonnull Function<String, String> textResolver) {
