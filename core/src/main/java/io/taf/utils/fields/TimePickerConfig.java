...
/**
 * Annotation to configure a {@link com.vaadin.flow.component.timepicker.TimePicker} component in a Vaadin application.
...
public @interface TimePickerConfig {
    ...
    /**
     * Specifies the default value of the {@link com.vaadin.flow.component.timepicker.TimePicker}.
     * The string should be in ISO-8601 time format (e.g., "HH:mm").
     * Corresponding method in Vaadin: {@link com.vaadin.flow.component.timepicker.TimePicker#setValue(LocalTime)}
     *
     * @return The default value for the {@link com.vaadin.flow.component.timepicker.TimePicker}.
     */
     ...
     * This is applicable to components like {@link com.vaadin.flow.component.timepicker.TimePicker}.
     ...
     * The string should be in ISO-8601 time format (e.g., "HH:mm").
     * Corresponding method in Vaadin: {@link com.vaadin.flow.component.timepicker.TimePicker#setMin(LocalTime)}
     *
     ...
     * The string should be in ISO-8601 time format (e.g., "HH:mm").
     * Corresponding method in Vaadin: {@link com.vaadin.flow.component.timepicker.TimePicker#setMax(LocalTime)}
     *
