...
/**
 * Annotation to configure a {@link NumberField} component in a Vaadin application.
...
public @interface NumberFieldConfig {
    ...
    /**
     * Specifies the default value of the {@link NumberField}.
     * Corresponding method in Vaadin: {@link NumberField#setValue(Double)}
     *
     ...
     * Corresponding method in Vaadin: {@link HasSuffix#setSuffixComponent(com.vaadin.flow.component.Component)}
     *
     * @return The prefix text.
     */
     ...
     * Corresponding method in Vaadin: {@link NumberField#setStepButtonsVisible(boolean)}
     *
     * @return True if the clear button should be visible, false otherwise.
     */
     ...
     * Corresponding method in Vaadin: {@link NumberField#setMin(double)}
     ...
     * Corresponding method in Vaadin: {@link NumberField#setMax(double)}
     ...
     * Corresponding method in Vaadin: {@link NumberField#setStep(double)}
